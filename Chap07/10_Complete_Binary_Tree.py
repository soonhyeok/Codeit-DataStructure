def get_parent_index(complete_binary_tree, index):
    ...
    if root_index >= len(complete_binary_tree) or complete_binary_tree[root_index] == None:
        return None
...
def get_left_child_index(complete_binary_tree, index):
    ...
    if left_index >= len(complete_binary_tree) or complete_binary_tree[left_index] == None:
        return None
...
def get_right_child_index(complete_binary_tree, index):
    ...
    if right_index >= len(complete_binary_tree) or complete_binary_tree[right_index] == None:
        return None
